    ...
    <main v-if="article" class="max-w-[1280px] mx-auto px-[20px] mt-[40px] text-black dark:text-white">
        ...
        <div class="mb-12">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a :href="`https://dev.to/elvisans/we-just-launched-website-importer-on-the-webflow-marketplace-57e1`" target="_blank" class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-4 mb-12">
            ...
            <a :href="`https://twitter.com/intent/tweet?text=We Just Launched Website Importer on the Webflow Marketplace 🚀&url=${currentUrl}`" target="_blank"
        ...
        <div class="flex items-center gap-4 mb-12 prose dark:prose-invert prose-lg">
            <p>You can like and comment this article on <a :href="`https://dev.to/elvisans/we-just-launched-website-importer-on-the-webflow-marketplace-57e1`"
...
const { setSeo } = useSeo()
setSeo({
    title: `We Just Launched Website Importer on the Webflow Marketplace 🚀 | Ansima's Blog`,
    description: `After months of development, testing, and feedback, I'm excited to share that Website Importer is now...`,
    image: `https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2F4swqpqjdl1vujgn01tkb.jpg`,
    type: 'article'
})
...
onMounted(async () => {
    try {
        const articleResponse = await fetch(`https://dev.to/api/articles/elvisans/we-just-launched-website-importer-on-the-webflow-marketplace-57e1`)
